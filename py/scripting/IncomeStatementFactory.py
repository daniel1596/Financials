from py.financials.YearQuarterCombination import YearQuarterCombination
...
class IncomeStatementFactory:
    ...
    def generate_QOQ_statements(starting_year: int, starting_quarter: Quarter):
        ...
        years_and_quarters = [YearQuarterCombination((last_year if q.number > starting_quarter.number else starting_year), q) for q in Quarter]
